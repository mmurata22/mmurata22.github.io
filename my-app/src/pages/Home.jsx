...
// --- ASSETS ---
import ssiThumb from '../assets/GrayWhiteUI.png'; 
import seraThumb from '../assets/seradashboard.png'; 

const caseStudies = [
  {
    id: 'sera',
    title: 'Sera Financial',
    category: 'Frontend Architecture • Data Viz',
    image: seraThumb, 
    link: '/work/sera',
    color: '#ebf4ff'
  },
  {
    id: 'ssi',
    title: 'Stereotyping Social Interactions',
    category: 'VR Development • UI Design',
    image: ssiThumb,
    link: '/work/ssi',
    color: '#e3e3e3'
  }
...
const Home = () => {
  ...
  // Define the style for the "Read Case Study" links here
      ...
      wrappers.forEach((wrapper) => {
        ...
        dots.forEach((dot) => {
          ...
          if (item) {
            ...
            const box = item.querySelector('.project-card');
  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <section className="featured-work-section" style={{ marginBottom: '6rem' }}>
          ...
          <div className="portfolio-grid">
            {caseStudies.map((project) => (
              <Link to={project.link} key={project.id} className="portfolio-card">
                <div className="portfolio-image-wrapper" style={{ backgroundColor: project.color }}>
                  {project.image ? (
        ...
        <div className="timeline-wrapper" style={{ marginBottom: '6rem' }}>
          ...
          <div className="timeline-item">
            ...
            <div className="timeline-content">
                <div className="project-card">
                  ...
                  <Link to="/work/sera" style={subtleLinkStyle}>Read Case Study →</Link>
                </div>
            </div>
          </div>
          ...
          <div className="timeline-item">
            ...
            <div className="timeline-content">
                <div className="project-card">
                  <h3 style={{ marginBottom: '0.2rem' }}>Nano|Human Interfaces Laboratory (NHI) @ Lehigh University</h3>
                  <p style={{ color: '#666', fontStyle: 'italic', marginBottom: '1rem', marginTop: 0 }}>VR Software Engineer & Co-Lab Manager</p>
                  <p>- Co-managed lab operations, establishing standard operating procedures (SOPs) for version control and asset organization to streamline workflows for a multi-developer team.</p>
                  <p>- Developed a self-guided Mixed Reality (MR) training simulation on Microsoft HoloLens for FIB and TEM microscopes, replacing manual instruction with interactive spatial lessons to reduce training overhead.</p>
                  <p>- Created AR visualization tools using Adobe Aero to render complex atomic structures (e.g., Ni6W6C) and biological models, directly supporting successful faculty grant applications.</p>
                  <p>- Executed end-to-end photogrammetry pipelines to digitize artifacts, applying mesh optimization techniques to convert high-poly scans into performance-ready assets for mobile AR.</p>
                </div>
            </div>
          </div>
          ...
          <div className="timeline-item">
            ...
            <div className="timeline-content">
                <div className="project-card">
                  <h3 style={{ marginBottom: '0.2rem' }}>Stereotyping Social Interactions Laboratory (SSI)</h3>
                  <p style={{ color: '#666', fontStyle: 'italic', marginBottom: '1rem', marginTop: 0 }}>VR Software Engineer & Researcher</p>
                  <p>- Served as a software developer during the project's foundational phase, building high-fidelity environments ("VR Coffee Shop," "VR Dorm") in Unity (C#) to facilitate psychological research on several socially stereotyped scenarios.</p>
                  <p>- Engineered immersive mechanics to optimize user comfort, implementing "fade-to-black" transitions to mitigate motion sickness and designing animated spatial UI for intuitive navigation.</p>
                  <p>- Directed motion capture sessions and utilized Reallusion Character Creator to populate scenes with realistic, diverse avatars essential for valid racial study data.</p>
                  ...
                  <Link to="/work/ssi" style={subtleLinkStyle}>Read Case Study →</Link>
                </div>
            </div>
          </div>
          ...
          <div className="timeline-item">
            ...
            <div className="timeline-content">
                <div className="project-card">
                  <h3 style={{ marginBottom: '0.2rem' }}>Research in Virtual Reality Laboratory (RiVR)</h3>
                   <p style={{ color: '#666', fontStyle: 'italic', marginBottom: '1rem', marginTop: 0 }}>VR Educational Simulation Developer</p>
                  <p>- Aided the technical modernization of the "Lehigh Gap Story" simulation, refactoring legacy code to ensure forward compatibility from Oculus Quest 1 to Quest 3 standards.</p>
                  <p>- Diagnosed and resolved critical errors in the PC-to-VR port of "Watershed Explorers," restoring full immersive functionality for environmental education tools.</p>
          ...
          <div className="timeline-item">
            ...
            <div className="timeline-content">
                <div className="project-card">
                  ...
                  <p>- Developed a machine learning software solution designed to automate the identification and categorization of recyclable materials to improve waste management efficiency.</p>
                  <p>- Built real-time recognition models using Python and OpenCV to accurately identify plastics (PET, HDPE), paper, glass, and aluminum.</p>
        ...
        <div className="footer-bottom">
          <div className="container footer-grid">
            <div className="footer-col brand-col">
              ...
              <p className="footer-tagline">Crafting immersive web & VR experiences.</p>
            </div>
