    ...
    <div className="container page-content">
      ...
      <div className="case-study-body">
        ...
        <section className="cs-section">
          ...
          <p>
           I participated in coordinated meetings between the <strong>Material Science Department</strong> and the <strong>Zoellner Arts Center</strong>. We established a 
        ...
        <section className="cs-section">
          ...
          <p>
            I imported both the optimized Arch and the custom Pedestal into <strong>Adobe Aero</strong>. 
